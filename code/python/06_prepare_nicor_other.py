...
# Tables
nicor_acs       = 'nicor_acs_combined_'
nicor_cong      = 'nicor_congenital_'
nicor_crm_eps   = 'nicor_crm_eps_'
nicor_crm_pmicd = 'nicor_crm_pmicd_'
nicor_minap     = 'nicor_minap_'
nicor_pci       = 'nicor_pci_'
nicor_tavi      = 'nicor_tavi_'
...
tavi = spark.table('.nicor_tavi__archive')

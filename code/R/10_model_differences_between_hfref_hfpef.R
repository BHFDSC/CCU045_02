...
death_res2 |>
  write_csv(here::here("figs", "subclass_comparison", "01_deaths_comparison.csv"))
hsp_res2 |>
  write_csv(here::here("figs", "subclass_comparison", "02_hosp_comparison.csv"))
subgroup_res |>
  write_csv(here::here("figs", "subclass_comparison", "03_subgroup_deaths_hosp_comparison.csv"))

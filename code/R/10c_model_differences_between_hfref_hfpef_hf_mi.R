...
death_res2 |>
  write_csv(here::here("figs", "subclass_comparison", "hf_mi", "01_deaths_comparison_hf_mi.csv"))
hsp_res2 |>
  write_csv(here::here("figs", "subclass_comparison", "hf_mi", "02_hosp_comparison_hf_mi.csv"))

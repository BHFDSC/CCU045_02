...
ad2 <- ad |>
  filter(
    ...
    error == 0, in_hosp_death != 1, !is.na(site), hhf == 0
  ) |>
  mutate(
...
write_csv(dth, here::here("figs", "comorbidities", "04_death_comorbidities_paf_newhf.csv"))
write_csv(hsp, here::here("figs", "comorbidities", "05_hospitalisation_comorbidities_paf_newhf.csv"))
write_csv(res_mi, here::here("figs", "comorbidities", "06_mi_results_comorbidities_newhf.csv"))

...
death_res2 |>
  write_csv(here::here("figs", "subclass_comparison", "04_deaths_comparison_newhf.csv"))
hsp_res2 |>
  write_csv(here::here("figs", "subclass_comparison", "05_hosp_comparison_newhf.csv"))
subgroup_res |>
  write_csv(here::here("figs", "subclass_comparison", "06_subgroup_deaths_hosp_comparison_newhf.csv"))

    ...
    if (missing(.by)) {
      ...
      fit <- coxph(
        Surv(acm_tte_1yr, acm_ep_1yr) ~ age + sex + ethnic + imd_fct + hf_fct +
          hcv19 + prior_hosp_1yr + care_home + hhf + adm_type + smok_known + comorb_fct + hdb + 
      ...
      fit <- coxph(
        Surv(acm_tte_1yr, acm_ep_1yr) ~ age + sex + ethnic + imd_fct + hcv19 + 
          prior_hosp_1yr + care_home + hhf + adm_type + smok_known + comorb_fct + hdb + hhtn + 
...
write_csv(dth, here::here("figs", "comorbidities", "01_death_comorbidities_paf.csv"))
write_csv(hsp, here::here("figs", "comorbidities", "02_hospitalisation_comorbidities_paf.csv"))
write_csv(res_mi, here::here("figs", "comorbidities", "03_mi_results_comorbidities.csv"))

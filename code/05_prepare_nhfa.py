...
dates = spark.table('.nicor_hf_v5__archive').select(f.col('archived_on')).distinct().sort(f.col('archived_on').desc())
dates.show()
...
# nhfa_v5_raw = spark.table('.nicor_hf_v5__archive')
